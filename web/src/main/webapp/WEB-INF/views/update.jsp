...
<body>
    ...
    <main>
        <div class="container">
           ...
           <form name="frm" action="/web/admin.update" method="post">
            <%Admin admin =(Admin) request.getAttribute("admin"); %>
                <p>이름 : <input name ="name" type="text" value="<%=admin.getName() %>" readonly="readonly"> </p>
                <p>주민등록번호 : <input name ="ssn" type="text" value="<%=admin.getSsn() %>" readonly="readonly"></p>
                <p>아이디 : <input name ="id" type="text" value="<%=admin.getId() %>" readonly="readonly"> </p>
                <p>비밀번호 : <input name="pw" type="text" value="<%=admin.getPw() %>"></p>
                <p>비밀번호 확인 : <input name="pw" type="text"  value="<%=admin.getPw() %>"></p>
